...
- **Commit/deploy WMS:** `457b681`; callable `finalizarConferenciaPA` e Hosting publicados em 2026-09-10 no projeto `prod-kuryos`. GitHub `main` pendente apenas do registro deste status.
